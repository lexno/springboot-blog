...
document.writeln("				<span>Email：lexno23@gmail.com</span>");
document.writeln("				<span>github：<a href='https://github.com/lexno/'>github.com/lexno</a></span>");
document.writeln("			</div>");
document.writeln("			<div id=\'rightContent\'>");
document.writeln("				<div id=\'footIcon\'>");
document.writeln("					<img id=\'logo\' src=\'img/logo.png\' />");
document.writeln("				</div>");
document.writeln("");
document.writeln("				<div id=\'copyright\'>");
document.writeln("					Copyright <a href='https://github.com/lexno/'>@lexno</a>,Design <a href='https://github.com/wmyskxz'>@wmyskxz</a>,2018-2019");
document.writeln("				</div>");
document.writeln("			</div>");
